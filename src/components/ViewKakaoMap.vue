  ...
  export default {
    ...
    watch: {
      locations() {
        ...
        this.start.x = this.locations[0].longitude;
        this.start.y = this.locations[0].latitude;
        const len = this.locations.length;
        this.end.x = this.locations[len-1].longitude;
        this.end.y = this.locations[len - 1].latitude;
        this.end.name = this.locations[len - 1].contentId;
        ...
        loadApi() {
              ...
              axios.post('https://apis-navi.kakaomobility.com/v1/waypoints/directions', params, {
                ...
                this.route.forEach((loc) => {
                    this.result_route = this.result_route + '->' + String(this.locations.find(location => location.contentId == loc).title);      
